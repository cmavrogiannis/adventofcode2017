...
void parse_instruction(string line, map<string,int> &reg)
{
...
int main(int argc, char *argv[])
{
	...
	cout << "the largest value in the register after executing all instructions is: " << mx << endl;
	return 0;
}
